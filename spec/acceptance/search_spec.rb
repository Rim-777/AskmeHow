...
To find question, answer or comment I want to be able to
search it} do
  ...
  scenario 'the user can search some question', js: true do
  ...
  scenario 'the user can search some answer', js: true do
    page_has_search_area
  ...
  scenario 'the user can search some comments', js: true do
    page_has_search_area
  ...
  scenario 'the user can search by users', js: true do
    page_has_search_area
  ...
  scenario 'the user can search by entered string', js: true do
    page_has_search_area
